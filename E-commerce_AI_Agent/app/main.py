...
# @app.get("/")
# def root():
#     return {"message": "Welcome to the E-commerce AI Agent. Use /docs to try the API."}
...
#     # If error was returned by sql_executor
...
# Allow frontend (adjust if your frontend is hosted elsewhere)
app.add_middleware(
    CORSMiddleware,
